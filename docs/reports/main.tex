...
To quantify uncertainty, we implement three Frequentist intervals. The application allows users to dynamically specify the confidence level $\alpha$ (defaulting to 95\%), which updates the critical $z$-score used in the calculations. Let $z$ be the $1 - \alpha/2$ quantile of the standard normal distribution:
\begin{itemize}
